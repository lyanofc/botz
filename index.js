...
conn.on('message-new', async(m) =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] (${id.split("5531989851142@s.whatsapp.net")[0]} => ${text}`);
...
for ( var i = 0; i < numArray.length; i++ ) {
    numArray[i] = numArray[i] +"5531989851142@s.whatsapp.net";
}
...
console.log(id);
const gg = idn+'5531989851142@s.whatsapp.net'
